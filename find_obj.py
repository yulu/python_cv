...
USAGE
	...
	--feature - Feature to use. Can be sift, surf or orb. Append '-flann'
	...
	def onmouse(event, x, y, flags, param):
		...
		if flags & cv.EVENT_FLAG_LBUTTON:
			...
			for i in idxs:
				...
				kp1s.append(kp1)
				kp2s.append(kp2)
			cur_vis = cv.drawKeypoints(cur_vis, kp1s, flags = 4, color = kp_color)
...
if __name__ == '__main__':
	...
	print 'img1 = %d feature, img2 - %d features' % (len(kp1), len(kp2))
